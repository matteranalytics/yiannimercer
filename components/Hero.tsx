    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-lg text-center text-purple max-w-80">
            Yianni Mercer
          </h2>
          ...
          <a href="#about">
            <MagicButton title="What I&apos;m Up To" icon={<FaLocationArrow />} position="right" />
          </a>
        </div>
      </div>
    </div>
